...
![image-20210325172644811](https://wendjiang.github.io/pics/ddia/chapter3.Storage&Retrieval/image-20210325172644811.png)
...
![image-20210325173501283](https://wendjiang.github.io/pics/ddia/chapter3.Storage&Retrieval/image-20210325173501283.png)
...
![image-20210325173837859](https://wendjiang.github.io/pics/ddia/chapter3.Storage&Retrieval/image-20210325173837859.png)
...
1. 合并 segment 简单效率，即使文件比可用内存还大。这个方法就像归并排序算法，下图是示意图：依次读取输入文件，对比每个文件的第一个 key，拷贝最小的 key 到输出文件，然后重复这个过程。输出的合并后的 segment file，也是按照 key 排序的
   ![image-20210325210446129](https://wendjiang.github.io/pics/ddia/chapter3.Storage&Retrieval/image-20210325210446129.png)
...
2. 为了检索文件中特定 key，你不需要在内存中维护所有 key 的索引。看下图：比如你在检索 key `handiwork`, 但是不知道这个 key 的 segment file offset。然而，你知道 handbag 和 handsome 的 offset，因为是排序的，所以 handiwork 一定在这两个 key 中间。这意味着你可以从 handbag 的 offset 开始搜索
   ![image-20210325212359453](https://wendjiang.github.io/pics/ddia/chapter3.Storage&Retrieval/image-20210325212359453.png)
...
![image-20210326111104300](https://wendjiang.github.io/pics/ddia/chapter3.Storage&Retrieval/image-20210326111104300.png)
...
![image-20210326123707858](https://wendjiang.github.io/pics/ddia/chapter3.Storage&Retrieval/image-20210326123707858.png)
